...
export function makeExpandedGroupSchema(overrides: Partial<ExpandedGroupSchema> = {}): ExpandedGroupSchema {
  return {
    id: 123,
    web_url: 'https://gitlab.example/groups/forge',
    name: 'forge',
    ...
    created_at: faker.date.past().toISOString(),
    parent_id: 0,
    runners_token: 'runners-token',
    file_template_project_id: 1,
    shared_with_groups: null,
    ...overrides,
  } satisfies ExpandedGroupSchema
}
