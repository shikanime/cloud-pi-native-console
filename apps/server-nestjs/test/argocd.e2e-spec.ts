...
import { GIT_RECONCILE_TIMEOUT, SYNC_EXTERNAL_TIMEOUT } from './e2e-timeout'
...
describeWithArgoCD('ArgoCDService (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    infraRepoPath = `${config.projectsRootDir}/infra/${zoneSlug}`
    try {
