...
describe('test project-role business', () => {
  ...
  describe('createRole', () => {
    it('should create role with incremented position when position 0 is the highest', async () => {
      ...
      prisma.projectRole.findFirst.mockResolvedValueOnce(dbRole as any)
      prisma.projectRole.findMany.mockResolvedValueOnce([dbRole as any])
      prisma.projectRole.create.mockResolvedValue(null as any)
  ...
  describe('deleteRole', () => {
    ...
    it('should delete role and remove id from concerned users', async () => {
      ...
      prisma.projectRole.findUnique.mockResolvedValueOnce(dbRole as any)
      prisma.projectMembers.findMany.mockResolvedValueOnce(members)
      prisma.projectRole.findMany.mockResolvedValueOnce([])
      prisma.projectRole.delete.mockResolvedValue(dbRole as any)
  ...
  describe.skip('countRolesMembers', () => {
    it('should return aggregated role member counts', async () => {
      ...
      prisma.projectRole.findMany.mockResolvedValue(partialRoles as any)
  ...
  describe('patchRoles', () => {
    ...
    it('should throw Forbidden403 when renaming a system role', async () => {
      ...
      prisma.projectRole.findMany.mockResolvedValue([systemRole] as any)
    ...
    it('should return 400 if incoherent positions', async () => {
      ...
      prisma.projectRole.findMany.mockResolvedValue(dbRoles as any)
